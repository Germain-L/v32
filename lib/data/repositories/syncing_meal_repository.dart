...
class SyncingMealRepository implements MealRepository {
  ...
  @override
  Future<List<Meal>> getMealsForDate(DateTime date) => _localRepo.getMealsForDate(date);
  
  @override
  Future<bool> hasMealsForDate(DateTime date) => _localRepo.hasMealsForDate(date);
}
